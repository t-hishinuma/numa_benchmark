...
fft_exec $DFFT2D_BACKWARD_EXEC $DFFT2D_MIN_SIZE $DFFT2D_MAX_SIZE $DFFT2D_INCL $DFFT2D_TRIAL ./src/fft/fft d backward 2

# fft-3D
fft_exec $SFFT3D_FORWARD_EXEC $SFFT3D_MIN_SIZE $SFFT3D_MAX_SIZE $SFFT3D_INCL $SFFT3D_TRIAL ./src/fft/fft f forward 3
fft_exec $DFFT3D_BACKWARD_EXEC $DFFT3D_MIN_SIZE $DFFT3D_MAX_SIZE $DFFT3D_INCL $DFFT3D_TRIAL ./src/fft/fft d backward 3
